...
class InMemoryDeviceKeystore : DeviceKeystore {
    ...
    override fun openSealed(associatedData: ByteArray, ciphertext: ByteArray): ByteArray {
...
class FileBlobStore(private val baseDir: File) : AtomicBlobStore {
...
class InMemoryStorageProvider(private val root: File) : StorageProvider {
